...
[Cesium Terrain Server](https://github.com/brickhouse-tech/cesium-terrain-server). It
...
```sh
docker run --name terrain -d --link memcache:memcached brickhouse-tech/cesium-terrain-server
```
...
```sh
docker run --name terrain -d --env MEMCACHED=memcache.me.org:11211 brickhouse-tech/cesium-terrain-server
```
...
[Cesium Terrain Server](https://github.com/brickhouse-tech/cesium-terrain-server)
...
will create a docker image tagged `brickhouse-tech/cesium-terrain-server:local`. This
...
[GitHub issue tracker](https://github.com/brickhouse-tech/cesium-terrain-server).
